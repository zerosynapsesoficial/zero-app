-- ==============================================================================
-- ZERO APP - REBUILD COMPLETO DE MENSAGENS E NOTIFICAÇÕES
-- Execute este script no SQL Editor do Supabase (Substitua todo o conteúdo)
-- ==============================================================================

-- 1. DROPAR TABELAS PARA GARANTIR LIMPEZA (Cuidado: apaga histórico de testes)
...
-- 4. CRIAR TRIGGER DE NOTIFICAÇÃO AUTOMÁTICA
...
BEGIN;
  -- Verifica se a publicação existe. Se não, não tem problema, comandos de ALTER não quebram.
  ALTER PUBLICATION supabase_realtime ADD TABLE public.messages;
  ALTER PUBLICATION supabase_realtime ADD TABLE public.notifications;
EXCEPTION WHEN OTHERS THEN
  -- Faz nada se a tabela já estiver na publicação
END;

-- 6. GARANTIR QUE A CONTA DE SUPORTE EXISTE
DO $$
DECLARE
